...
export default function ForgotPassword() {
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-b from-[#b2d1f7] to-white flex justify-center items-start sm:items-center overflow-y-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleResetRequest} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3.5 bg-sky-50/30 border border-gray-200/80 rounded-2xl focus:outline-none focus:ring-4 focus:ring-sky-500/10 focus:border-sky-500 focus:bg-white text-gray-900 text-sm transition-all duration-300 placeholder:text-gray-400"
            />
          </div>
