...
export default function WelcomePage() {
  return (
    <>
      ...
      <main className="h-auto md:h-screen w-full bg-[#FAFBFC] flex flex-col md:flex-row m-0 p-0 overflow-y-auto md:overflow-hidden selection:bg-[#3F37C9] selection:text-white">
        
        {/* Left Column: Exactly your original laptop code */}
        ...
        {/* Right Column: Exactly your original laptop code with mobile bottom breathing room */}
        <div className="w-full md:w-1/2 bg-white px-6 py-12 sm:p-12 md:p-16 lg:p-24 flex flex-col justify-center items-center md:items-start shrink-0 pb-20 md:pb-0">
